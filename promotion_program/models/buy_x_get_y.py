...
class BuyXGetY(models.Model):
    ...
    promotion_form_id2 = fields.Many2one('promotion.form', string='Inventory Details')
    ...
    @api.depends('selection_frame_manufacturer', 'selection_frame_collection', 'many2many_field_selection',
                 ...
                 'selection_lens_filter', 'selection_lens_treatment_category',
                 'selection_contact_lens_replacement_schedule',
