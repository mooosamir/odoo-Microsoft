odoo.define('gws_google_maps.GplaceAutocompleteFields', function (require) {
    'use strict';

    var BasicFields = require('web.basic_fields');
    var core = require('web.core');
    var Utils = require('gws_google_maps.Utils');
    var _t = core._t;
        ...
        initGplacesAutocomplete: function () {
            ...
            setTimeout(function () {
                if (!self.places_autocomplete) {
                    ...
                    self.places_autocomplete.setFields(["address_component"]);
                }
