odoo.define('web_one2many_kanban.web_one2many_kanban', function (require) {
    ...
    KanbanRecord.include( {
        _render: function () {
            var self = this;
            this.qweb_context.isNaN = isNaN
            this.qweb_context.parseInt = parseInt
            var def =this._super.apply(this, arguments);
            var o2x_field_names = [];
            _.each(this.fieldsInfo, function (field_info, field_nm) {
                if (field_nm == "recall_type_ids"){
//                    console.log("recall_type_ids");
//                    _.each(field_nm, function (o2x_field_name) {
                        var record = self.qweb_context.record[field_nm];
//                        console.log(record.raw_value.length);
...
//                    });
                ...
                else if (field_nm == "recall_type_ids")
                    o2x_field_names.push(field_nm);
