odoo.define('opt_appointment.ResourcePopover', function (require) {
"use strict";
...
var ResourceViewPopover = Widget.extend(StandaloneFieldManagerMixin, {
    template: 'ResourceView.event.popover',
    events: {
    ...
    init: function (parent, eventInfo) {
        ...
        this.record = eventInfo.event.record;
        this.eventStart = moment(eventInfo.eventTime.time.split('-')[0], 'HH:mm').format('HH:mm A');
        this.eventEnd =   moment(eventInfo.eventTime.time.split('-')[1], 'HH:mm').format('HH:mm A');
        //console.log("EVENT START::::::::::", this.eventStart, this.eventEnd)
    },
    /**
     * @override
     */
