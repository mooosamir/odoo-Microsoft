odoo.define('opt_appointment.DashboardView', function (require) {
    ...
    var DashboardModel = require('opt_appointment.DashboardModel');
    var DashboardRenderer = require('opt_appointment.DashboardRenderer');
    var DashboardController = require('opt_appointment.DashboardController');
    ...
    var DashboardView = AbstractView.extend({
        ...
        jsLibs: ['/opt_appointment/static/src/lib/fullcalendars.js',
