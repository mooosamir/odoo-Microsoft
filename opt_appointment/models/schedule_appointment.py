...
class ScheduleAppointment(models.Model):
    ...
    company_id = fields.Many2one('res.company', "Location", default=lambda self: self.env.company)
    ...
    def write(self, values):
        ...
        return super(ScheduleAppointment, self).write(values)
    ...
    def create(self, values):
        ...
        if values['recurrency']:
            ...
            if values['rrule_type'] == 'daily':
                if values['end_type'] == 'count':
                    for i in range(0, values['count'], values['interval']):
                        ...
                        super(ScheduleAppointment, self).create(new_values)
                else:
            ...
            return super(ScheduleAppointment, self).create(values)
        else:
            return super(ScheduleAppointment, self).create(values)
